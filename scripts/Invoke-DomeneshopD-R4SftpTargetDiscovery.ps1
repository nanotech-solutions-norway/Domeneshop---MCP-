...
Write-Host ''
Write-Host '============================================================'
Write-Host 'DOMENESHOP MCP — D-R4 SFTP TARGET DISCOVERY (READ-ONLY)'
Write-Host 'Office PC / /www bounded discovery only'
Write-Host '============================================================'
...
Write-Host ''
Write-Host '=== 4. Execute bounded read-only discovery ==='
Write-Host 'Search root: /www'
Write-Host 'Arbitrary subtree scan: false'
...
$ExitCode=1
try{
    & $Python 'scripts\sftp_d_r4_target_discovery.py'
...
Write-Host ''
Write-Host '============================================================'
Write-Host "D_R4_SFTP_DISCOVERY_EXIT_CODE=$ExitCode"
Write-Host 'WRITE_TOOLS_ENABLED=false'
Write-Host 'SFTP_CREATE_AUTHORIZED=false'
Write-Host 'SFTP_OVERWRITE_AUTHORIZED=false'
Write-Host 'SFTP_DELETE_AUTHORIZED=false'
Write-Host '============================================================'
if($ExitCode-ne 0){throw 'D-R4 SFTP target discovery did not resolve one unique exact candidate. HOLD.'}
