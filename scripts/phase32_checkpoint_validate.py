"""Validate the Phase 32 checkpoint."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate the Phase 32 checkpoint.")
    parser.add_argument("--repo-root", default=".")
    parser.add_argument("--output", default="phase32-checkpoint-validation-report.json")
    ...
    payload = {
        "summary": {
            "mode": "phase32_checkpoint_validation",
            "phase32_checkpoint": "CHECKPOINT_ONLY" if passed else "CHECK_FAILED",
            "release_decision": "HOLD_PHASE32_CHECKPOINT_ONLY" if passed else "HOLD_FOR_FIX",
            "passed": passed,
...
def validate(root: Path) -> list[Check]:
    ...
    checks.append(Check("hold:phase32", "HOLD_PHASE32_CHECKPOINT_ONLY" in combined, "Required Phase 32 hold marker."))
