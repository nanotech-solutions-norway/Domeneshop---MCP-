"""Validate the Phase 34 checkpoint."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate the Phase 34 checkpoint.")
    parser.add_argument("--repo-root", default=".")
    parser.add_argument("--output", default="phase34-checkpoint-validation-report.json")
    ...
    payload = {
        "summary": {
            "mode": "phase34_checkpoint_validation",
            "phase34_checkpoint": "CHECKPOINT_ONLY" if passed else "CHECK_FAILED",
            "release_decision": "HOLD_PHASE34_CHECKPOINT_ONLY" if passed else "HOLD_FOR_FIX",
            "passed": passed,
...
def validate(root: Path) -> list[Check]:
    ...
    checks.append(Check("hold:phase34", "HOLD_PHASE34_CHECKPOINT_ONLY" in combined, "Required Phase 34 hold marker."))
