"""Validate the Phase 30 checkpoint."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate the Phase 30 checkpoint.")
    parser.add_argument("--repo-root", default=".")
    parser.add_argument("--output", default="phase30-checkpoint-validation-report.json")
    ...
    payload = {
        "summary": {
            "mode": "phase30_checkpoint_validation",
            "phase30_checkpoint": "CHECKPOINT_ONLY" if passed else "CHECK_FAILED",
            "release_decision": "HOLD_PHASE30_CHECKPOINT_ONLY" if passed else "HOLD_FOR_FIX",
            "passed": passed,
...
def validate(root: Path) -> list[Check]:
    ...
    checks.append(Check("hold:phase30", "HOLD_PHASE30_CHECKPOINT_ONLY" in combined, "Required Phase 30 hold marker."))
