"""Validate the Phase 27 review index gate."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate the Phase 27 review index gate.")
    parser.add_argument("--repo-root", default=".")
    parser.add_argument("--output", default="phase27-review-index-validation-report.json")
    ...
    payload = {
        "summary": {
            "mode": "phase27_review_index_validation",
            "phase27_review": "REVIEW_INDEX_ONLY" if passed else "CHECK_FAILED",
            "release_decision": "HOLD_PHASE27_REVIEW_INDEX_ONLY" if passed else "HOLD_FOR_FIX",
            "passed": passed,
