"""Validate the Phase 25 chain index gate."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate the Phase 25 chain index gate.")
    parser.add_argument("--repo-root", default=".")
    parser.add_argument("--output", default="phase25-chain-index-validation-report.json")
    ...
    payload = {
        "summary": {
            "mode": "phase25_chain_index_validation",
            "phase25_chain": "CHAIN_INDEX_ONLY" if passed else "CHECK_FAILED",
            "release_decision": "HOLD_PHASE25_CHAIN_INDEX_ONLY" if passed else "HOLD_FOR_FIX",
            "passed": passed,
