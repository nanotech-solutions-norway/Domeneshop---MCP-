"""Validate the Phase 26 continuity index gate."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate the Phase 26 continuity index gate.")
    parser.add_argument("--repo-root", default=".")
    parser.add_argument("--output", default="phase26-continuity-index-validation-report.json")
    ...
    payload = {
        "summary": {
            "mode": "phase26_continuity_index_validation",
            "phase26_continuity": "CONTINUITY_INDEX_ONLY" if passed else "CHECK_FAILED",
            "release_decision": "HOLD_PHASE26_CONTINUITY_INDEX_ONLY" if passed else "HOLD_FOR_FIX",
            "passed": passed,
