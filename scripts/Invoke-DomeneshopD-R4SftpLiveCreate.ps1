...
$ExpectedBranch='main'
$ReleaseId='D-R4-SFTP-CREATE-20260824-001'
$TargetHash='0619d5e786da50c431b090667936a2076b7bbd1054bda5758c30d74eec7f2f2a'
$PayloadHash='9e37287a5e29a0d911589ac470ce83c5cabfeba6f0672c24935b6c2df96aa21a'

Write-Host ''
Write-Host '============================================================'
Write-Host 'DOMENESHOP MCP — D-R4 AUTHORIZED SFTP CREATE'
Write-Host 'Exact one-file mutation / no overwrite / no delete'
Write-Host '============================================================'
...
$env:SFTP_D_R4_CREATE_AUTHORIZED='true'
$env:SFTP_D_R4_RELEASE_ID=$ReleaseId
$env:SFTP_D_R4_TARGET_SHA256=$TargetHash
$env:SFTP_D_R4_PAYLOAD_SHA256=$PayloadHash
$env:SFTP_D_R4_OVERWRITE_AUTHORIZED='false'
...
$ExitCode=1
try{
    & $Python 'scripts\sftp_d_r4_live_create.py'
    $ExitCode=$LASTEXITCODE
}
finally{
    $env:SFTP_D_R4_CREATE_AUTHORIZED='false'
    $env:SFTP_D_R4_RELEASE_ID=$null
    $env:SFTP_D_R4_TARGET_SHA256=$null
    $env:SFTP_D_R4_PAYLOAD_SHA256=$null
    $env:SFTP_D_R4_OVERWRITE_AUTHORIZED='false'
    $env:SFTP_D_R4_DELETE_AUTHORIZED='false'
    $env:WRITE_TOOLS_ENABLED='false'
    $env:DRY_RUN_DEFAULT='true'
...
Write-Host ''
Write-Host '============================================================'
Write-Host "D_R4_SFTP_LIVE_CREATE_EXIT_CODE=$ExitCode"
Write-Host 'WRITE_TOOLS_ENABLED=false'
Write-Host 'SFTP_OVERWRITE_AUTHORIZED=false'
Write-Host 'SFTP_DELETE_AUTHORIZED=false'
Write-Host '============================================================'
if($ExitCode-ne 0){throw 'D-R4 authorized SFTP CREATE did not complete with verified readback. HOLD.'}
