"""Validate the Phase 28 inventory index gate."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate the Phase 28 inventory index gate.")
    parser.add_argument("--repo-root", default=".")
    parser.add_argument("--output", default="phase28-inventory-index-validation-report.json")
    ...
    payload = {
        "summary": {
            "mode": "phase28_inventory_index_validation",
            "phase28_inventory": "INVENTORY_INDEX_ONLY" if passed else "CHECK_FAILED",
            "release_decision": "HOLD_PHASE28_INVENTORY_INDEX_ONLY" if passed else "HOLD_FOR_FIX",
            "passed": passed,
