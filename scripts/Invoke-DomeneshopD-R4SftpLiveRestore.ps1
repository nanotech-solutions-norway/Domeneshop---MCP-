...
$ExpectedBranch='main'
$ReleaseId='D-R4-SFTP-RESTORE-20260824-001'
$TargetHash='0619d5e786da50c431b090667936a2076b7bbd1054bda5758c30d74eec7f2f2a'
$BeforeHash='482c668063d3b849337b82d5c04dcbcb7fb65a8ccfdae3226a61c5c7e4527203'
$AfterHash='9e37287a5e29a0d911589ac470ce83c5cabfeba6f0672c24935b6c2df96aa21a'

Write-Host ''
Write-Host '============================================================'
Write-Host 'DOMENESHOP MCP — D-R4 AUTHORIZED SFTP RESTORE'
Write-Host 'Exact one-file restore / no delete / no rename / no broader overwrite'
Write-Host '============================================================'
...
$env:SFTP_D_R4_RESTORE_AUTHORIZED='true'
...
$ExitCode=1
try{
    & $Python 'scripts\sftp_d_r4_live_restore.py'
    $ExitCode=$LASTEXITCODE
}
finally{
    $env:SFTP_D_R4_RESTORE_AUTHORIZED='false'
...
Write-Host ''
Write-Host '============================================================'
Write-Host "D_R4_SFTP_LIVE_RESTORE_EXIT_CODE=$ExitCode"
...
Write-Host '============================================================'
if($ExitCode-ne 0){throw 'D-R4 authorized SFTP RESTORE did not complete with verified readback. HOLD.'}
