"""Validate the Phase 31 checkpoint."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate the Phase 31 checkpoint.")
    parser.add_argument("--repo-root", default=".")
    parser.add_argument("--output", default="phase31-checkpoint-validation-report.json")
    ...
    payload = {
        "summary": {
            "mode": "phase31_checkpoint_validation",
            "phase31_checkpoint": "CHECKPOINT_ONLY" if passed else "CHECK_FAILED",
            "release_decision": "HOLD_PHASE31_CHECKPOINT_ONLY" if passed else "HOLD_FOR_FIX",
            "passed": passed,
...
def validate(root: Path) -> list[Check]:
    ...
    checks.append(Check("hold:phase31", "HOLD_PHASE31_CHECKPOINT_ONLY" in combined, "Required Phase 31 hold marker."))
