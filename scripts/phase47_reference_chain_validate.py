"""Validate Phase 47 reference chain summary."""
...
DOC = "docs/PHASE47_REFERENCE_CHAIN_SUMMARY.md"
FILES = [
    DOC,
...
def main() -> int:
    ...
    parser.add_argument("--output", default="phase47-reference-chain-report.json")
    ...
    payload = {"summary": {"mode": "phase47_reference_chain", "passed": passed, "check_count": len(checks), "failed_count": sum(1 for item in checks if not item["passed"])}, "checks": checks}
